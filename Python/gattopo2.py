...
#
# Questa classe sincronizza meglio la funzione di stampa, che puÃ² avvenere solo dopo una modifica
# PuÃ² tuttavia ancora verificarsi che:
#  1. Il display fatica a prendere il lock e si perde una modifica consecutiva a un altra (sapreste perchÃ© e come risolvere?)
#  2. Se il topo non si muove poichÃ¨ sorteggia uno spostamento di 0, il display fa una stampa inutile in piÃ¹ (sapresti risolvere?)
#
class StrisciaMigliore(Striscia):
    ...
    def __init__(self):
        ...
        #
        # Non posso piÃ¹ usare un Lock ma devo usare un RLock
    ...
    def printStriscia(self):
        #
        # N.B. il lock Ã¨ giÃ  acquisito ma mi serve un RLock per evitare che il programma si blocchi
        #
        with self.lockUnico:
...
# Per avere la versione dove il display Ã¨ sincronizzato, usare StrisciaMigliore
#
#striscia = Striscia()
