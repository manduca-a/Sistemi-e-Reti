...
class BlockingStack:
    ...
    def __init__(self,size):
        ...
        self.conditionInsufficiente = Condition(self.lock)
    ...
    def putN(self, L : List):
        self.lock.acquire()
        while len(L) > self.size-len(self.elementi):
            self.conditionInsufficiente.wait()
        for x in L:
    ...
    def take(self,t=None):
        ...
        try:
            if t == None:
                ...
                self.conditionInsufficiente.notify_all()
